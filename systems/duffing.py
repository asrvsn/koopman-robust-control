...
def dataset(tmax: int, n: int, alpha=-1.0, beta=1.0, gamma=0.5, delta=0.3, omega=1.2, x0=1.0, xdot0=0.0):
	t = np.linspace(0, tmax, n)
	f = odeint(system, (x0, xdot0), t, args=(alpha, beta, gamma, delta, omega))
	X, Y = f[:-1].T, f[1:].T
